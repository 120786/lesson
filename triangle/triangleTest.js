...
QUnit.test("isosceles triangle has two equal sides", function( assert ) {
	...
	assert.equal(triangle.isIsosceles(-1,1,1),false,"-1,1,1 is isosceles") ;
	assert.equal(triangle.isIsosceles(1,1,1),true,"1,1,1 is isosceles") ;
});
QUnit.test("scalene triangle has three different sides", function( assert ) {
	...
	assert.equal(triangle.isScalene(1,1,1),false,"1,1,1 is not scalene") ;
	assert.equal(triangle.isScalene(-1,1,1),false,"-1,1,1 is not scalene") ;
